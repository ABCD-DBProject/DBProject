...
<body class="text-center">
	...
	<div class="container-login">
			...
			<h1 class="h3 mb-3 font-weight-normal title-bar">Staff Login</h1>
			<div class="form-sl container">
			<ul class="nav nav-tabs">
    		<li class="active"><a data-toggle="tab" href="login.jsp">Staff Login</a></li>
    		<li><a data-toggle="tab" href="login2.jsp">Manager Login</a></li>
			</ul>
			...
			<div class="tab-content login-tab">
				<div id="menu1" class="tap-pane fade in active">
					<div class="container">
						<form class="from-input form-login" id="formLogin" action="loginAction.jsp" method="post">
					...
					<p class="text-muted">Are you a non-member? <a href="register.jsp">Join Membership</a></p>
					</form>
					</div>
				</div>
			</div>
