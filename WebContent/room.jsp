				...
				<div class="navbar-wrapper">
					...
					<div class="navbar-logo">
						<a class="mobile-menu" id="mobile-collapse" href="#!"> <i
							...
							class="ti-search"></i>
						</a> <a href="index.html"> <img class="img-fluid abcd"
					...
					<div class="navbar-container container-fluid">
						...
						<ul class="nav-right">
							<li class="user-profile header-notification"><a href="#!">
									<span><%=name%>님</span> <i class="ti-angle-down"></i>
							</a>
								<ul class="show-notification profile-notification">
									<li><a href="index.html"> <i class="ti-user"></i> My
											page
									</a></li>
					...
					<nav class="pcoded-navbar">
						...
						<div class="pcoded-inner-navbar main-menu">
							<div class="">
								<div class="main-menu-header">
									<div class="user-details">
										<span><%=name%>님</span> <span id="more-details"><%=dname%><i
								...
								<div class="main-menu-content">
									<ul>
										<li class="more-details"><a href="index.html"><i
												class="ti-user"></i>View my page</a> <a href="logout.jsp"><i
							...
							<ul class="pcoded-item pcoded-left-item">
								...
								<li class=""><a href="myattend.html"> <span
										class="pcoded-micon"><i
											class="icofont icofont icofont icofont-file-document bg-c-pink"></i></span>
										<span class="pcoded-mtext"
										data-i18n="nav.basic-components.main">My attendence</span> <span
										class="pcoded-mcaret"></span>
								</a></li>
								<li class="active"><a href="room.html"> <span
										class="pcoded-micon"><i class="ti-layers"></i></span> <span
										class="pcoded-mtext" data-i18n="nav.basic-components.main">Meeting
											room</span> <span class="pcoded-mcaret"></span>
								</a></li>
								<li class="pcoded-hasmenu "><a href="javascript:void(0)">
										<span class="pcoded-micon"><i
											class="icofont icofont-table bg-c-yellow"></i></span> <span
										class="pcoded-mtext" data-i18n="nav.menu-levels.main">My
											holiday</span> <span class="pcoded-mcaret"></span>
								</a>
									<ul class="pcoded-submenu">
										<li class=""><a href="holidayf.html"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.menu-levels.menu-level-21">Request
													Form</span> <span class="pcoded-mcaret"></span>
										</a></li>
										<li class=""><a href="holidayl.html"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.menu-levels.menu-level-23">Request
													List</span> <span class="pcoded-mcaret"></span>
										</a></li>
									</ul>
							</ul>
							...
							<ul class="pcoded-item pcoded-left-item">
								<li class="pcoded-hasmenu "><a href="javascript:void(0)">
									...
									<ul class="pcoded-submenu">
										<li class=""><a href="location.html"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.menu-levels.menu-level-21">Location</span> <span
												class="pcoded-mcaret"></span>
										</a></li>
										<li class=""><a href="info.html"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
													...
													<div class="card-block">
														...
														<form action="reserveAction.jsp" method="post">
															...
															<div class="form-group row">
																...
																<div class="col-sm-10">
																	<input type="text" class="form-control" name="RDATE"
															...
															<div class="form-group row">
																...
																<div class="col-sm-10">
																	<select name="RTIME">
																		...
																		<option value="A1">9:00 ~ 11:00</option>
																		<option value="A2">11:00 ~ 1:00</option>
																		<option value="B1">14:00 ~ 16:00</option>
																		<option value="B2">16:00 ~ 18:00</option>
																	</select>
																	<!--disabled 속성 고려-->
																</div>
															</div>
